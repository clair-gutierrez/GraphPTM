...
x_train = np.load('/home/aliak/datasets/k_53_emb_no_labels/x_train_emb_no_labels.npy', allow_pickle=True).astype('float32')
x_validation = np.load('/home/aliak/datasets/k_53_emb_no_labels/x_validation_emb_no_labels.npy', allow_pickle=True).astype('float32')
x_test = np.load('/home/aliak/datasets/k_53_emb_no_labels/x_test_emb_no_labels.npy', allow_pickle=True).astype('float32')

y_train = np.load('/home/aliak/datasets/k_53_emb_no_labels/y_train_emb_no_labels.npy', allow_pickle=True).astype('float32')
y_validation = np.load('/home/aliak/datasets/k_53_emb_no_labels/y_validation_emb_no_labels.npy', allow_pickle=True).astype('float32')
y_test = np.load('/home/aliak/datasets/k_53_emb_no_labels/y_test_emb_no_labels.npy', allow_pickle=True).astype('float32')
...
model.save('emb_CNN_no_labels.h5')
