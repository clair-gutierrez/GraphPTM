...
x = tf.keras.Input(shape=(53, 22, 1), dtype='float32')
layer_3 = Conv2D(16, (3, 3), padding='valid', input_shape=(53, 22, 1), activation='relu', kernel_regularizer=l2(1e-06))(x)
layer_4 = MaxPooling2D(pool_size=(2,2), padding='valid')(layer_3)
layer_5 = Reshape((25*10, 16))(layer_4)
...
model.save('attention_no_labels.h5')
