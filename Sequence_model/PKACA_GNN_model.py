...
list_adj=np.load("/home/aliak/spektral_graph/r_15/PKCA/PKACA_adj.npy", allow_pickle=True) #type is numpy array
list_features=pickle.load(open("/home/aliak/spektral_graph/r_15/PKCA/PKACA_node_feat.pickle", "rb")) #type is list
...
#negatives
list_n_adj=np.load("/home/aliak/spektral_graph/r_15/PKCA/PKACA_neg_adj.npy", allow_pickle=True)
list_n_features = pickle.load(open("/home/aliak/spektral_graph/r_15/PKCA/PKACA_neg_node_feat.pickle", "rb"))
...
X_2 = EdgeConv(16, activation='relu')([X_in, A_in])
X_3 = GATConv(16, activation='relu')([X_2, A_in])
X_4 = GlobalAvgPool()([X_3, I_in])
output = Dense(n_out, activation="softmax")(X_4)
